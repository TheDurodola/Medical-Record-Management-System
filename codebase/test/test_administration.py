...
class MyTestAdmin(unittest.TestCase):
    ...
    def test_that_multiple_doctors_can_be_registered(self):
        ...
        self.assertEqual(0, self.admin.check_doctor_database_size())
        self.admin.register_doctor("Victoria%","Oginni", "Fiyinfoluwa", "Oncology", "08148260470")
        self.admin.register_doctor("MoneyMan12","Doe", "John", "Cardiology", "08123456789")
        self.assertEqual(2, self.admin.check_doctor_database_size())

    def test_that_doctor_first_name_can_be_update(self):
        self.admin.clear_doctor_database()
        self.admin.register_doctor("Victoria%","Aginni", "Fiyinfoluwa", "Oncology", "08148260470")
    ...
    def test_that_doctor_last_name_can_be_update(self):
        self.admin.clear_doctor_database()
        self.admin.register_doctor("Victoria$","Oginni", "Feyifoluwa", "Oncology", "08148260470")
...
Phone No: 08148260470"""
    ...
    def test_that_doctor_cant_be_created_with_invalid_details(self):
        self.admin.clear_doctor_database()
        with self.assertRaises(ValueError):
            self.admin.register_doctor("Victoria$","Oginni", "Fiyinfoluwa", "Onc0logy", "08148260470")
        with self.assertRaises(ValueError):
