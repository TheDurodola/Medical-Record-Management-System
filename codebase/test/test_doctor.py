...
class TestDoctor(unittest.TestCase):
    def test_validate_doctor_creation(self):
        doctor = Doctor("DOC232", "jayjus23", "Justine", "Babatunde", "Gynecologist", "09021885123")
    ...
    def test_invalid_first_name_with_a_character(self):
        with self.assertRaises(ValueError):
            Doctor("DOC232", "jayjus23", "J/ustine", "Babatunde", "Gynecologist", "09021885123")

    def test_invalid_password_with_a_password_less_than_8_character(self):
        with self.assertRaises(ValueError):
            doctor = Doctor("DOC232", "jay7", "Justine", "Babatunde", "Gynecologist", "09021885123")

    def test_invalid_last_name_with_a_space_in_between_the_name(self):
        with self.assertRaises(ValueError):
            Doctor("DOC232", "jayjus23","Justine", "Baba tunde", "Gynecologist", "09021885123")

    def test_invalid_specialization_with_a_number(self):
        with self.assertRaises(ValueError):
            Doctor("DOC232", "jayjus23", "Justine", "Babatunde", "Gy45necologist", "09021885123")

    def test_invalid_phone_number_with_an_empty_string(self):
        with self.assertRaises(ValueError):
            Doctor("DOC232", "jayjus23","Justine", "Babatunde", "Gynecologist", "")
